...
- Core source/API/SDKs: `andrewmuratov/gapwise`
- Native mobile: `andrewmuratov/gapwise-mobile`

## Current developer-platform release facts

- TypeScript `@gapwise/sdk@0.1.0` is published on npm with provenance.
- `@gapwise/sdk` is reserved on JSR and linked to `andrewmuratov/gapwise` for GitHub Actions OIDC. Until a JSR version actually exists, Status must not describe JSR as a completed registry release.
